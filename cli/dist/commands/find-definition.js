...
exports.findDefinitionCommand = findDefinitionCommand;
const chalk_1 = __importDefault(require("chalk"));
const client_js_1 = require("../client.js");
const utils_js_1 = require("../utils.js");
function findDefinitionCommand(program) {
    program
        ...
        const response = await client.callTool("ide_find_definition", args);
        if (opts.json) {
