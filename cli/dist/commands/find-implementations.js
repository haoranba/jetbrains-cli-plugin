...
exports.findImplementationsCommand = findImplementationsCommand;
const chalk_1 = __importDefault(require("chalk"));
const client_js_1 = require("../client.js");
const utils_js_1 = require("../utils.js");
function findImplementationsCommand(program) {
    program
        .command("find-implementations")
        .description("Find implementations of interface/method")
        ...
        const response = await client.callTool("ide_find_implementations", args);
        if (opts.json) {
