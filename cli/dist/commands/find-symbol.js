...
exports.findSymbolCommand = findSymbolCommand;
const chalk_1 = __importDefault(require("chalk"));
const client_js_1 = require("../client.js");
const utils_js_1 = require("../utils.js");
function findSymbolCommand(program) {
    program
        .command("find-symbol")
        .description("Search for symbols (classes, methods, fields) by name")
        .requiredOption("--query <query>", "Symbol name to search for")
        ...
        const response = await client.callTool("ide_find_symbol", args);
        if (opts.json) {
