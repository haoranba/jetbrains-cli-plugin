...
exports.syncFilesCommand = syncFilesCommand;
const chalk_1 = __importDefault(require("chalk"));
const client_js_1 = require("../client.js");
const utils_js_1 = require("../utils.js");
function syncFilesCommand(program) {
    program
        .command("sync-files")
        .description("Force sync IDE's VFS and PSI cache with external file changes")
        ...
        const args = {};
        const response = await client.callTool("ide_sync_files", args);
        if (opts.json) {
