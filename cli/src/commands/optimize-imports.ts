...
export function optimizeImportsCommand(program: Command) {
  program
    .command("optimize-imports")
    .description("Optimize imports (remove unused, organize)")
    ...
    .action(async (options, cmd) => {
      ...
      const response = await client.callTool("ide_optimize_imports", args);
